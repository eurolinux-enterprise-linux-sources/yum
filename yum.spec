...
Source3:	yum-spec_provide_yum-autoupdate.patch
Source4:	yum.ini
...
# For SL historic compatibility
Provides:	yum-autoupdate
%if %{yum_cron_systemd}
...
-->  Added Provides: yum-autoupdate for historic compat with SL5/6
- Added Patch: yum-cron-apply-updates.patch
